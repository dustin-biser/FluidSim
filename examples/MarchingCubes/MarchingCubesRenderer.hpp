...
private:
    ...
    // transform feedback buffer for vertex position stream.
    GLuint streamBuffer_wsPositions;

    // transform feedback buffer for vertex normal stream.
    GLuint streamBuffer_wsNormals;

    // Use for rendering triangles generated by marching cubes.
    GLuint vao_isoSurfaceTriangles;
    ...
    void generateIsoSurfaceTriangles(GLuint volumeData_texture3d,
